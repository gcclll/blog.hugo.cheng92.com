...
#+name: compiler-core
#+begin_src js -n -r :noweb no-export :tangle "~/github/mine/blog.cheng92.com/assets/tests/compiler-core.js"
...
#+name: baseCompile
#+begin_src js -n -r :noweb no-export
<<globalVars>>
