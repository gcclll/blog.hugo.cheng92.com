...
[[compile-testing][交互式测试]](ElementPlus + Vue3 实现，由本文最后生成的 compiler-core.js 编译)
#+end_box
#+html: <br>
...
:ID:       3035f86a-3d31-4fe7-9fe5-11ded6d19b83
:END:
...
** transform()
:PROPERTIES:
:ID:       fe0fa544-bd86-4a81-b472-c1eaa3889fdb
:END:
...
const ast = baseParse(`<span/><div>hello</div><p>world!</p><span/>`)
const c1 = ast.children[0]
const c2 = ast.children[1]
const c3 = ast.children[2]
const childCount = ast.children.length
...
*** transformElement()
:PROPERTIES:
:ID:       27ceff76-40d6-40b4-9e6d-49a85b3dc27f
:END:
...
function buildProps(
  ...
  for (let i = 0; i < props.length; i++) {
    ...
    if (prop.type === NodeTypes.ATTRIBUTE) {
      ...
      if (!arg && (isVBind || isVOn)) { (ref:transformElement-bind-on-no-arg)
        hasDynamicKeys = true
        if (exp) {
    ...
    switch (propsExpression.type) {
      case NodeTypes.JS_OBJECT_EXPRESSION:
        ...
        if (!hasDynamicKey) {
          ...
          propsExpression = createCallExpression( (ref:transformElement-normalizeProps)
...
*** transformBind
:PROPERTIES:
:ID:       d3cd8afe-f0e9-43b5-96f6-22837f5bec8d
:END:
...
:ID:       53aa5092-68c3-4f90-a517-f8c51d7f340f
:END:
...
** genNode()
:PROPERTIES:
:ID:       28c5ab6d-f87d-4fb3-ba8e-2eb16a95f99b
:END:
...
*** genText()
:PROPERTIES:
:ID:       a628391c-8cfa-4cc7-9e46-ff0eb57b205c
:END:
...
*** genExpression()
:PROPERTIES:
:ID:       116b60a9-f41c-4e53-8fbe-b2b1b14a7da5
:END:
...
*** genInterpolation()
:PROPERTIES:
:ID:       5187ed65-1c32-4796-a45a-b9ed0e3d3fff
:END:
...
*** genCompoundExpression()
:PROPERTIES:
:ID:       4eeb3657-e62e-4eaf-b1d6-ce34ce9b9748
:END:
...
*** genVNodeCall()
:PROPERTIES:
:ID:       1c43b047-4d39-46a8-b3d8-40313179ff8d
:END:
...
*** genCallExpression()
:PROPERTIES:
:ID:       33b0bdac-8475-41cf-8a91-473df4618137
:END:
...
*** genObjectExpression()
:PROPERTIES:
:ID:       55e66c31-078b-4677-9718-46eeb86411be
:END:
...
*** genArrayExpression()
:PROPERTIES:
:ID:       e5754d56-a0fd-4246-9672-9269e97f1da4
:END:
...
*** genFunctionExpression()
:PROPERTIES:
:ID:       d0e4eeb2-4de3-47a8-91bd-a910368ea03a
:END:
...
*** genConditionalExpression()
:PROPERTIES:
:ID:       25019161-a6ef-4b95-98d5-33ec79b3bcac
:END:
...
*** genCacheExpression()
:PROPERTIES:
:ID:       7c1c3213-31c8-494f-848c-3c6d5c1d79f6
:END:
...
*** genNodeList()
:PROPERTIES:
:ID:       ffe14c2e-0c00-4e89-87c8-adb2f35f0287
:END:
...
*** genTemplateLiteral()
:PROPERTIES:
:ID:       6f46373e-c60b-4269-a642-c3659cf3ce8f
:END:
...
*** genIfStatement()
:PROPERTIES:
:ID:       6ba0299d-c849-48ef-84ec-1afcdee00398
:END:
...
*** genAssignmentExpression()
:PROPERTIES:
:ID:       f2e83e15-9186-4b78-a1bd-3c688b44d708
:END:
...
*** genSequenceExpression()
:PROPERTIES:
:ID:       92d260d8-41b5-4e20-85a6-119fa209bbb3
:END:
...
*** genReturnStatement()
:PROPERTIES:
:ID:       ef3013ff-9bdb-4d2f-b465-2e68addd499b
:END:
...
:ID:       959aa202-5dde-4931-b3f1-5ebc961256c1
:END:

结合 ast parser -> transform -> codegen 使用 compile 函数将 SFC 编译成 render 函
数。

#+begin_details compiler-core.js :title-color red
#+name: compiler-core
...
测试及案例分析(含流程图)，输入对应的模板生成 render 函数:
...
旧博客中包含很多测试用例和对应的流程图可供参考：[[https://www.cheng92.com/vue/vue-mind-map-house-cc/][Vue3 源码头脑风暴之☞compiler-core - 若叶知秋]]
** global variables

使用到的一些公共变量和函数：
#+html: <br>
#+begin_details global variables :title-color red
#+name: globalVars
